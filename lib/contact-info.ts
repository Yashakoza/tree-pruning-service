export const BUSINESS_CONFIG = {
  businessName: "עץ תמיר",
  businessShortName: "עץ תמיר",
  ...
  heroSubheadline:
    "עץ תמיר מספק שירותי גיזום, עיצוב ודילול עצים, הסרת ענפים מסוכנים, גיזום בגובה ותחזוקת עצים — לבתים פרטיים, בנייני מגורים ועסקים. עבודה מסודרת, בטוחה ועם פינוי גזם בסיום.",
  services: [
    {
